...
import { getAnxieuxSoinsDentaires, getAppareilDentaireUneFois, getAutresRemarquesUtiles, getAutresRemarquesUtilesOuiNon, getCommentConnaissezVousLeCabinet, getModifierDents, getModifierDentsOuiNon, getPreoccupationDents, getPreoccupationDentsOuiNon } from '../store/adultState/diversInfo';
import AddText from './AddText';
import BooleanAndText from './BooleanAndText';
